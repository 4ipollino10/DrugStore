...
namespace DrugStoreAPI.Mappers.OrderMappers
{
    public class OrdersMapper
    {
        ...
        public Order OrderDTOtoOrder(OrderDTO dto)
        {
            ...
            order.AppointedDate = DateTime.SpecifyKind(order.AppointedDate, DateTimeKind.Utc);
            order.ReceivingDate = DateTime.SpecifyKind(order.ReceivingDate, DateTimeKind.Utc);
